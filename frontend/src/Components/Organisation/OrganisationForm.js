...
const OrganisationForm = (props) => (
  <form className={props.editOrgonaizationForm}>
    <div className={props.formFirstRow}>
      <TextField
        className={props.firstField || props.editOrgnasiationName}
      ...
      <h6 className={props.notIncludeInAddOrg || props.detailsArea}>Area:</h6>
        <TextField
        className={props.secondField || props.textField}
          label="Area"
          name={props.area}
      ...
      <h6 className={props.notIncludeInAddOrg || props.detailsArea}>| Borough:</h6>
        <TextField
        className={props.thirdField || props.textFieldTwo}
          label="Borough"
          name={props.borough}
    ...
    <h4 className={props.notIncludeInAddOrg}>- Health advice</h4>
    <TextField
      ...
      onChange={props.onChange}
    />
    <div className={props.formSecondRow}>
        <TextField
        className={props.firstField}
          label="Process"
        name={props.process}
    ...
    <div className={props.formThirdRow}>
        <TextField
          multiline
          rows="4"
          label="Service"
